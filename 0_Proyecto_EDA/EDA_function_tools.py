...
# Frecuencias absolutas y relativas tanto de una variable categórica como de una lista de varaibles categóricas
...
# Frecuencias absolutas y relativas tanto de una variable categórica como de una lista de varaibles categóricas
# Fórmula adaptada por mal funcionamiento de la anterior
...
# Quartiles y rangos (var. numéricas)
...
# Quartiles y rangos agrupados (var. numéricas y categóricas)
def plot_boxplot_grouped(df, column_to_plot, group_column):
    if df[column_to_plot].dtype in ['int64', 'float64'] and df[group_column].dtype in ['object', 'category']:
        sns.boxplot(data=df, x=group_column, y=column_to_plot)
        plt.show()

# Función de densidad de probabilidad ( var. numéricas)
...
# Gistogramas y diagramas de caja (var. numéricas y categóricas)
...
# Una modificación de la anterior ya que daba problemas        
...
# Comparación de frecuencias,tanto relativas como absolutas, entre variobles categóricas.
...
# Comparación de diferentes medidas entre variables numéricas y variables categóricas
...
# Formato `diagrama de caja`: Diferentes medidas de la variable numércias en función de los valores de la categórica
...
# Formato `histograma`: Diferentes medidas de la variable numércias en función de los valores de la categórica
...
# Gráfico de dispersión para comparar de forma visual (y también numérica) la correlación (de Pearson) entro dos varaibles numéricas:
...
# Muestra en un solo gráfico tres valroes numéricos siendo el tamaño de la burbuja el de la variable directora.
...
'''
# Hasta aquí todo en orden según "600. resúmenes de gráficos" de "obsidian" a 25/03/2024
